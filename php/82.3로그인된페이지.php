<!-- 세션있냐 없냐에 따라서 로그인페이지를 다이렉트로 접근하는걸 막는 코드 -->
<!-- 아이가 일치함에도 불구하고 페이지 접근이 안된다면 print_r로 확인을 해봐야함 -->
<?php 
session_start();
print_r($_SESSION);

if(!isset($_SESSION['id'])|| $_SESSION['id'] ==''){
die('이 페이지에 접근 할 수 없습니다');
}
    ...
    <main class="flex-shrink-0">
        <div class="container">
            ...
            <p class="lead">
                ...
                navbar
                has been added with <code class="small">padding-top: 60px;</code> on the
